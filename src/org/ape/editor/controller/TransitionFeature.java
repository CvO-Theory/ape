...
import org.ape.editor.commands.AddTransitionCommand;
...
public class TransitionFeature extends Feature {
	...
	public TransitionFeature(Root root) {
		super(root);
			...
			if (mouseButton == MouseEvent.BUTTON1) {
				if (APE.getRoot().getClickedElement() instanceof Node) {
					...
					APE.getRoot()
							.getUndoManager()
							.executeCommand(
									new AddTransitionCommand(APE.getRoot()
