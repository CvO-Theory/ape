...
public class TokenButton extends JToggleButton implements Observer {

	private final FeatureType featureType = FeatureType.TOKEN;
	private ActiveFeature activeFeature;

	public TokenButton(Root root, Action selectTool_TokenAction) {
		super(selectTool_TokenAction);
