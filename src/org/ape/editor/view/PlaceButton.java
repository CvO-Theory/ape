...
public class PlaceButton extends JToggleButton implements Observer {

	private final FeatureType featureType = FeatureType.PLACE;
	private ActiveFeature activeFeature;

	public PlaceButton(Root root, Action selectTool_PlaceAction) {
		super(selectTool_PlaceAction);
