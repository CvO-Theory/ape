...
public class ArcButton extends JToggleButton implements Observer {

	private final FeatureType featureType = FeatureType.ARC;
	private ActiveFeature activeFeature;

	public ArcButton(Root root, Action selectTool_ArcAction) {
		super(selectTool_ArcAction);
