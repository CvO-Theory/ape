...
public class TransitionButton extends JToggleButton implements Observer {

	private final FeatureType featureType = FeatureType.TRANSITION;
	private ActiveFeature activeFeature;

	public TransitionButton(Root root, Action selectTool_TransitionAction) {
		super(selectTool_TransitionAction);
