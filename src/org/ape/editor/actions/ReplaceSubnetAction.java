...
import org.ape.editor.commands.ReplaceSubnetsCommand;
import org.ape.editor.commands.ReplaceSubnetsLooseMethodCommand;
...
public class ReplaceSubnetAction extends AbstractAction {
	...
	public ReplaceSubnetAction(Root root) {
		...
		putValue(SMALL_ICON, GraphicsTools.getIcon("ape/replacesubnet.gif"));
		setEnabled(false);
	}
