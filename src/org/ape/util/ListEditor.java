...
public class ListEditor<E> extends JPanel implements ActionListener, ListSelectionListener {
	...
	public ListEditor(String title, ListModel<E> model, Frame parent) {
		...
		addButton.setIcon(GraphicsTools.getIcon("ape/Add16.gif"));
		editButton.setIcon(GraphicsTools.getIcon("ape/Preferences16.gif"));
		deleteButton.setIcon(GraphicsTools.getIcon("ape/Remove16.gif"));
